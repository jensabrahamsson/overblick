...
Note: DreamCapability and DreamSystem tests are in test_dream_capability.py
...
# ── DreamSystem / DreamCapability tests moved ────────────────────────────────
# DreamSystem tests: tests/capabilities/test_dream_system.py
# DreamCapability tests: tests/capabilities/test_dream_capability.py
# DreamType/DreamTone enum tests remain below.
...
# ── _load_dream_guidance tests in test_dream_capability.py ───────────────────
